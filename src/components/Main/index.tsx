...
export const Main = () => {
    return (
        <main id="grid-container">
            <div className="main">
                    <h2>Destaques</h2><hr className="hr" />
                ...
                <div className="footer">
                    <div className="item4">
                        ...
                        <img src="./img/klipartz.com.png" alt="icone do JavaScript" className="img2" />
                        <img src="./img/nodejs.png" alt="icone do node js" className="img3"/>
                        <img src="./img/react.png" alt="" className="img3"/>
                    </div>
                </div>
            </div>
        </main>
